                            ...
                            <div class="card h-150px card-xxl-stretch">
                                <div class="card-body d-flex align-items-center justify-content-between flex-wrap">
                                    <div class="me-2">
                                        ...
                                        <div class="text-muted fw-bold fs-6">Generate the latest CRM
                                            report for company projects</div>
                                    </div>
                                ...
                                <div class="card-body d-flex flex-column justify-content-between">
                                    ...
                                    <div class="m-0">
                                        <a href='#' class="btn btn-success fw-bold px-6 py-3"
                                            data-bs-toggle="modal" data-bs-target="#kt_modal_create_app">Create Report</a>
                                    </div>
                                </div>
                            </div>
