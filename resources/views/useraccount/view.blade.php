                    ...
                    <div class="d-flex overflow-auto h-55px">
                        ...
                        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder flex-nowrap"
                            ...
                            @if ($data['rulemenutransaction']->create == 'Y')
                                <li class="nav-item">
                                    <a class="nav-link text-active-primary me-6" href="">Create</a>
                                </li>
                            @endif
                            <li class="nav-item">
                                <a class="nav-link text-active-primary me-6 active" href="">View</a>
                            </li>
                            <li class="nav-item">
                ...
                <div class="d-flex flex-wrap my-1">
                    ...
                    <div class="d-flex my-0">
                        ...
                        <select name="status" data-control="select2" data-hide-search="true"
                            data-placeholder="Filter" class="form-select form-select-white form-select-sm w-150px me-5">
                        ...
                        <!--begin::Select-->
                        <select name="status" data-control="select2" data-hide-search="true"
                            data-placeholder="Export" class="form-select form-select-white form-select-sm w-100px">
                                ...
                                <table id="kt_project_users_table"
                                    ...
                                    <thead class="fs-7 text-gray-400 text-uppercase">
                                        <tr>
                                            ...
                                            <th class="min-w-200px">Users Level</th>
                                    ...
                                    @foreach ($data['user'] as $user)
                                        <tr>
                                            <td>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <a href=""
                                                            class="mb-1 text-gray-800 text-hover-primary">{{ $user->karyawan->biodata->nama_lengkap }}</a>
                                                        <div class="fw-bold fs-6 text-gray-400">{{ $user->username }}
                                                        </div>
                                            ...
                                            <td>
                                                <span
                                                    class="badge badge-light-primary fw-bolder px-4 py-3">{{ $user->userlevel->level }}</span>
                                            </td>
                                            <td>
                                                <span
                                                    class="badge badge-light-primary fw-bolder px-4 py-3">{{ $user->role->role }}</span>
                                            </td>
                                            <td class="text-end">
                                                <a href="/user/{{ Crypt::encrypt($user->id . '_' . $user->karyawan_id) }}"
